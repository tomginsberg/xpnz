export default {
  ...
  input: ({ props }) => ({
    class: [
      ...
      "border",
      {
        "bg-surface-0 dark:bg-gray-700": !props.multiple,
  ...
  dropdownbutton: {
    root: {
      class: [
        ...
        "bg-primary-500 dark:bg-gray-700",
        "border-r border-t border-b border-primary-500 dark:border-gray-600",
